...
import com.oxygensend.auth.ui.auth.request.PasswordChangeRequest;
import com.oxygensend.auth.ui.auth.request.PasswordResetRequest;
import com.oxygensend.auth.ui.auth.request.UserIdRequest;
import com.oxygensend.auth.ui.auth.request.VerifyEmailRequest;
...
import static com.oxygensend.auth.ui.SwaggerConstants.USER_BLOCK_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_CHANGE_PASSWORD_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_DELETE_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_GENERATE_EMAIL_VERIFICATION_TOKEN_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_GENERATE_PASSWORD_RESET_TOKEN_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_NAME;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_RESET_PASSWORD_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_UNBLOCK_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.USER_VERIFY_EMAIL_API_DESCRIPTION;
...
class UserController {
    ...
    void createUser(@Validated @RequestBody CreateUserRequest request) {
        service.createUser(CreateUserCommand.fromRequest(request));
    }
}
