package com.oxygensend.auth.ui.auth;
...
import static com.oxygensend.auth.ui.SwaggerConstants.AUTHENTICATE_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.AUTH_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.AUTH_NAME;
import static com.oxygensend.auth.ui.SwaggerConstants.REFRESH_TOKEN_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.REGISTER_API_DESCRIPTION;
import static com.oxygensend.auth.ui.SwaggerConstants.VALIDATE_TOKEN_API_DESCRIPTION;
...
class AuthController {
    ...
    RegisterResponse register(@RequestBody @Validated RegisterRequest request) {
        var userIdAndTokens = authService.register(RegisterCommand.fromRequest(request));
