package com.oxygensend.auth.ui.rest.resources.auth;


import com.oxygensend.auth.application.auth.AuthService;
import com.oxygensend.auth.ui.rest.resources.auth.request.AuthenticationRequest;
import com.oxygensend.auth.ui.rest.resources.auth.request.RefreshTokenRequest;
import com.oxygensend.auth.ui.rest.resources.auth.request.RegisterRequest;
import com.oxygensend.auth.ui.rest.resources.auth.response.AuthenticationResponse;
import com.oxygensend.auth.ui.rest.resources.auth.response.RegisterResponse;
import com.oxygensend.auth.ui.rest.resources.auth.response.ValidationResponse;
import com.oxygensend.auth.ui.rest.resources.SwaggerConstants;
