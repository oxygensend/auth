...
//import com.oxygensend.auth.domain.model.loginType.UserId;
...
//        var tokenPair = new AuthenticationTokensDto("accessToken", "refreshToken");
//        when(authService.register(any())).thenReturn(Pair.of(userId, tokenPair));
//
//        // Act & Assert
...
//        // Arrange
//        var tokenPair = new AuthenticationTokensDto("accessToken", "refreshToken");
//        when(authService.authenticate(anyString(), anyString())).thenReturn(tokenPair);
//
//        // Act & Assert
...
//        // Arrange
//        var tokenPair = new AuthenticationTokensDto("accessToken", "refreshToken");
//        when(authService.refreshToken(anyString())).thenReturn(tokenPair);
//
//        // Act & Assert
...
//                                               .value(response.userId() != null ? response.userId().toString() : null))
